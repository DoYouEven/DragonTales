...
[AddComponentMenu("DragonTales/Icon Slot")]
public class IconSlot : UIDragDropItem
{
    ...
    protected override void OnDragDropRelease(GameObject surface)
    {
        if (surface != null)
        {
            IconSlot targetSlot = surface.GetComponent<IconSlot>();
    ...
    protected virtual void AttachToTemporary(GameObject temporary)
    {
        ...
        IconSlot slot = temporary.AddComponent(this.GetType().ToString()) as IconSlot;
